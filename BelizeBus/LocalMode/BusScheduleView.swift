...
extension BusScheduleView{
    fileprivate func setupAllViews(){
        ...
        busTypeLabel.anchor(top: innerView.topAnchor, bottom: timeLineView.topAnchor, left: timeLineView.leftAnchor, right: nil, topPadding: 0, bottomPadding: 8, leftPadding: 0, rightPadding: 0, width: 60, height: 0)
    ...
    func setupDefaultBusCompanyLabel(companyName: String) {
        ...
        defaultBusCompanyLabel.anchor(top: nil, bottom: timeLineView.topAnchor, left: leftAnchor, right: timeLineView.leftAnchor, topPadding: 0, bottomPadding: -5, leftPadding: 25, rightPadding: 8, width: 0, height: 16)
